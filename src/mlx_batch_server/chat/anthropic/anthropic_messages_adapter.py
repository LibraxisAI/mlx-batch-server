...
class AnthropicMessagesAdapter:
    ...
    def _prepare_generation_params(self, request: MessagesRequest) -> dict[str, Any]:
        ...
        if request.thinking and isinstance(request.thinking, ThinkingConfigEnabled):
            ...
            # TODO: Add thinking_budget support when ChatGenerator supports it
        ...
        # TODO: Add stop_sequences support when ChatGenerator supports it
    ...
    def _map_finish_reason(
        ...
        return finish_reason_map.get(finish_reason, StopReason.END_TURN)
